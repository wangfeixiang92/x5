...
<head>
    ...
    <link href="<?= \app\common\CommonHelper::getAssetUrl('/css/web-detail.css') ?>" rel="stylesheet">
    ...
    <!-- 富文本编辑器-->
    <script type="text/javascript" src="<?= \app\common\CommonHelper::getAssetUrl('/ckeditor_basic/ckeditor.js') ?>"></script>
    <script type="text/javascript" src="<?= \app\common\CommonHelper::getAssetUrl('/ckeditor_basic/config.js') ?>"></script>
</head>
<body>
<header id="header">
