...
function hcMailCompletion(mailId){
	//常用属性设置
	this.hcMailList = new Array('qq.com','163.com','sina.com','126.com','sohu.com','139.com','gmail.com','hotmail.com','yahoo.com','yahoo.com.cn','21cn.com','live.com');
	this.padding             = 2;
	this.borderWidth         = 1;
	...
	this.hcShowMailList = function(){
		...
		if($('#hcShowMailList').find('div:visible').length < 1){
			$('#hcShowMailList').remove();
			$('#hcMailCompletionCss').remove();
		}else{
			var sObj             = this;
